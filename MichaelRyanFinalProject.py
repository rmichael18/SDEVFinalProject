"""
Project: D&D Random Character Creator
Author: Ryan Michael
Date Last Updated: 05/01/23
Purpose: Randomly generate a character for Dungeons & Dragons
"""
...
def STATMOD(STAT):  # Stat modifier determination
    if STAT == 1:
        return -5
    if STAT == 2 or STAT == 3:
        return -4
...
Level = int(input("Enter character level: "))  # This is where you change Character Level
...
if Race == "Dryad": # Extra Race I found https://www.dandwiki.com/wiki/Dryad_(5e_Race)
    Subrace = ["Watcher"]  # Leaving this as a list in case I get around to adding the Guardian subclass
    Subrace = random.choice(Subrace)
    DEX = StatIncrease(DEX, 1)
...
if Race == "Succubus": # Extra class I found https://www.dndbeyond.com/races/1524-succubus
    ...
    Traits.extend(["Charm", "Darkvision (60ft)", "Fiendish Nature", "Shapechanger", "Small Wings"])
